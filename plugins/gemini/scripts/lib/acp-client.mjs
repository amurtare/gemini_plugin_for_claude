...
export class AcpClient {
  ...
  onUpdate(handler) {
    ...
    // Return unsubscribe function to prevent handler leak
    return () => {
      const idx = this._updateHandlers.indexOf(handler);
      if (idx !== -1) this._updateHandlers.splice(idx, 1);
    };
  }
  ...
  _sendRequest(method, params = {}, timeoutMs = 120_000) {
    if (this.exited) {
